sabrina = Player.create(username: 'boots1234', email: 'sabrina@gmail.com', password_digest: 'sabrina', name: 'Sabrina', age: 27, birthdate: '11/26/1993')

dom = Player.create(username: 'santiago1234', email: 'dominic@gmail.com', password_digest: 'dominic', name: 'Dominic', age: 30, birthdate: '02/06/1990')

thomas = Player.create(username: 'dngrb4x', email: 'thomas@gmail.com', password_digest: 'thomas', name: 'Thomas', age: 32, birthdate: '06/12/1988')
...
grog = Character.create(character_name: 'Grog', character_level: 17, character_race: 'Orc', character_class: 'Fighter', armor_class: 20, character_speed: 35, character_strength: 4, character_dexterity: 3, character_constitution: 4, character_intelligence: 2, character_wisdom: 3, character_charisma: 2, weapon_proficiencies: 'Martial', armor_proficiencies: 'all-armor', languages: 'Orcish', player_id: 3)
